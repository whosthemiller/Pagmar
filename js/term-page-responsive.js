...
export const TERM_PAGE_RESPONSIVE = {
  ...
  imageHeightFactor: { wide: 0.47, narrow: 0.44, compact: 0.4 },
};
 ...
 *   emphasizeHeadingColumns: number,
 ...
 *   obscureValueColumnFromRight: number,
 *   labelRowHeadingColumns: number,
 *   labelRowHeadingColumnFromRight: number,
 *   labelRowValueColumns: number,
 *   labelRowValueColumnFromRight: number,
 *   metaHeadingColumns: number,
 *   metaHeadingColumnFromRight: number,
 *   metaValueColumns: number,
 *   metaValueColumnFromRight: number,
...
export function getTermPageScrollLayoutConfig(viewportWidth) {
  ...
  if (tier === "compact") {
    return {
      ...
      emphasizeHeadingColumns: 3,
      emphasizeHeadingColumnFromRight: 4,
      emphasizeValueColumns: 14,
      emphasizeValueColumnFromRight: 7,
      obscureHeadingColumns: 3,
      obscureHeadingColumnFromRight: 4,
      obscureValueColumns: 14,
      obscureValueColumnFromRight: 7,
      labelRowHeadingColumns: 3,
      labelRowHeadingColumnFromRight: 4,
      labelRowValueColumns: 14,
      labelRowValueColumnFromRight: 7,
      metaHeadingColumns: 3,
      metaHeadingColumnFromRight: 4,
      metaValueColumns: 14,
      metaValueColumnFromRight: 7,
      metaGapColumns: 0,
      labelPanelColumns: 6,
    };
  }
  if (tier === "narrow") {
    return {
      ...
      detailsImageColumnFromRight: 4,
      emphasizeHeadingColumns: 2,
      emphasizeHeadingColumnFromRight: 4,
      emphasizeValueColumns: 8,
      emphasizeValueColumnFromRight: 6,
      obscureHeadingColumns: 2,
      obscureHeadingColumnFromRight: 4,
      obscureValueColumns: 8,
      obscureValueColumnFromRight: 6,
      labelRowHeadingColumns: 2,
      labelRowHeadingColumnFromRight: 4,
      labelRowValueColumns: 8,
      labelRowValueColumnFromRight: 6,
      metaHeadingColumns: 2,
      metaHeadingColumnFromRight: 4,
      metaValueColumns: 10,
      metaValueColumnFromRight: 6,
      metaGapColumns: 0,
      labelPanelColumns: 6,
    };
  }
  return {
    ...
    definitionColumnFromRight: 5,
    imageColumns: 16,
    imageColumnFromRight: 5,
    detailsImageColumns: 16,
    detailsImageColumnFromRight: 5,
    emphasizeHeadingColumns: 2,
    ...
    obscureValueColumnFromRight: 15,
    labelRowHeadingColumns: 2,
    labelRowHeadingColumnFromRight: 5,
    labelRowValueColumns: 6,
    labelRowValueColumnFromRight: 7,
    metaHeadingColumns: 3,
    metaHeadingColumnFromRight: 15,
    metaValueColumns: 7,
    metaValueColumnFromRight: 18,
    metaGapColumns: 0,
    labelPanelColumns: 5,
  };
}
