...
const INTRO_PARAGRAPHS = [
  `${BRAND_PHRASE} הוא אינדקס אינטראקטיבי של מושגים בעלי פרשנויות לשוניות שונות בשיח הפוליטי בישראל. הוא בוחן כיצד מילים אינן רק מתארות מציאות, אלא גם מעצבות אותה.`,
  ...
  `האתר אוסף, ממפה ומציג מונחים אלו לצד מידע על משמעותם, הקשרי השימוש שלהם, תקופת השימוש בהם והמסגרות הלשוניות שהם מבטאים. מטרתו אינה לקבוע איזו פרשנות נכונה יותר, אלא לעודד התבוננות ביקורתית באופן שבו השפה משפיעה על הדרך שבו אנו מבינים את העולם.`,
  `הפרויקט נולד מתוך שאיפה לבחון את השפה באופן פתוח ככל האפשר, אך גם מתוך ההכרה שכל פעולת מיון, הגדרה ועריכה היא בחירה פרשנית. לכן, הוא אינו מבקש לעמוד מחוץ לשפה שהוא חוקר, אלא להפנות את תשומת הלב לכוחה של השפה עצמה ולתפקידה בעיצוב נרטיבים, תפיסות וזיכרון.`,
];
